...
var command_map = map[string]Command{
	...
	"REGISTER":     *NewCommand(not_implemented, map[string]string{"cap_req": "account-registration"}, true),
	"VERIFY":       *NewCommand(not_implemented, map[string]string{"cap_req": "account-registration"}, true),
	"CAP":          *NewCommand(cap, make(map[string]string), false),
	"ERROR":        *NewCommand(not_implemented, make(map[string]string), false),
	...
	"LIST":         *NewCommand(not_implemented, make(map[string]string), false),
	"JOIN":         *NewCommand(join, map[string]string{"auth_req": "true"}, true),
	"PROTOCTL":     *NewCommand(not_implemented, make(map[string]string), false),
	...
	"NOTIFY":       *NewCommand(not_implemented, map[string]string{"auth_req": "true"}, false),
